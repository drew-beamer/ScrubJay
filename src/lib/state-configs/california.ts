import { californiaFilter } from '../filters';
import { RareBirdAlertConfig } from '../rare-bird-alert/types';
...
const regionChannels = {
  ...
  'Northern San Joaquin Valley': ['1156452103133343814', '1156611323543695390'],
  'Southern San Joaquin Valley': ['1156452147156758589', '1156611606197837884'],
  'Superior California': ['1156452191129841674', '1156610530816045207'],
  'North Coast': ['1156452314236862484', '1156610816217452645'],
};

type CaliforniaRegions = keyof typeof regionChannels;

const countyRegions: Record<string, CaliforniaRegions> = {
...
const californiaConfig: RareBirdAlertConfig<CaliforniaRegions> = {
  regionCode: 'US-CA',
  statewideChannels: ['1151958598264574002', '1152421317300207637'],
